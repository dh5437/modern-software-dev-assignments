...
Examples:
- Correct: tool: read_file({{"filename": "hello.txt"}})
- Incorrect: tool: read_file(filename="hello.txt")
...
def get_full_system_prompt():
    ...
    for tool_name in TOOL_REGISTRY:
        ...
        tool_str_rep += f"\n{"="*15}\n"
    return SYSTEM_PROMPT.format(tool_list_repr=tool_str_rep)
...
def run_coding_agent_loop():
    ...
    while True:
        ...
        while True:
            ...
            tool_invocation = extract_tool_invocations(assistant_response)
            if not tool_invocation:
                ...
                break
            for name, args in tool_invocation:
